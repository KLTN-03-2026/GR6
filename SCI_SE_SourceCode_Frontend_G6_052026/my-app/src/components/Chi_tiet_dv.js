...
const Chi_tiet_dv = () => {
  ...
  const serviceDetail = {
    ...
    comments: [
      { id: 1, author: "Nguyễn Thùy Linh", time: "2 ngày trước", content: "Dịch vụ cực kỳ tốt, nhân viên tay nghề cao và rất nhiệt tình.", rating: 5 },
      { id: 2, author: "Trần Văn Nam", time: "1 tuần trước", content: "Cắt tóc đẹp, massage rất thư giãn.", rating: 5 }
    ]
  };
